...
gb.characters.get(id, function (err2, res2, json2) {
	...
	if (query === 'info'){
		embedString += '**Description: ' + json2.results.deck + '**\n';
		if (json2.results.first_appeared_in_game.hasOwnProperty !== undefined && json2.results.first_appeared_in_game.hasOwnProperty !== null && typeof json2.results.first_appeared_in_game.hasOwnProperty !== undefined && typeof json2.results.first_appeared_in_game.hasOwnProperty !== null){
